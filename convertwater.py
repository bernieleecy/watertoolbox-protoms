...
def convertwater(pdb_in,watermodel,ignorH=False,watresname=None):
  ...
  opc_model = np.array([[39.437, 9.946, 15.166],[39.192, 10.434, 14.486],[40.300, 9.873, 15.066],[39.528, 10.007, 15.051]])
  opc_names = ["O00","H01","H02","M03"]
  ...
  elif watermodel.upper() in ["OPC"]:
      if watresname==None:
          wresnm = "OPC"
      else:
          wresnm = watresname
      pdb_out.solvents = _rottranstemplate(solvents,opc_model,opc_names,ignorH,wresnm)
  else:
